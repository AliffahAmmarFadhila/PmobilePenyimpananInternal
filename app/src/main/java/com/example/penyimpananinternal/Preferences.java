package com.example.penyimpananinternal;
...
public class Preferences {
    ...
    static final String KEY_USER_TEREGISTER ="NIM", KEY_PASS_TEREGISTER ="pass";
    static final String KEY_USERNAME_SEDANG_LOGIN = "NIM_logged_in";
